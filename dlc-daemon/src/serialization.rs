use crate::contract::{
    AcceptedContract, ContractDescriptor, ContractInfo, DifferenceParams, EnumDescriptor,
    FundingInputInfo, NumericalDescriptor, NumericalEventInfo, OfferedContract, SignedContract,
};
use crate::payout_curve::{
    ConstantPayoutCurvePiece, HyperbolaPayoutCurvePiece, PayoutCurvePiece, PayoutFunction,
...
use dlc::{EnumerationPayout, OracleInfo, PartyParams, Payout, TxInputInfo};
...
use dlc_messages::oracle_msgs::{
    EventDescriptor, OracleAnnouncement, OracleInfo as SerOracleInfo, OracleInfoV0, OracleInfoV1,
    OracleInfoV2, OracleParamsV0,
};
use dlc_messages::{
...
impl From<&PayoutCurvePiece> for SerPayoutCurvePiece {
    fn from(piece: &PayoutCurvePiece) -> SerPayoutCurvePiece {
        match piece {
            PayoutCurvePiece::PolynomialPayoutCurvePiece(p) => {
                SerPayoutCurvePiece::PolynomialPayoutCurvePiece(p.into())
            }
